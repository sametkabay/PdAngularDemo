...
export class CampaignService {
  ...
  private readonly apiUrl_GetAll = "http://proximitydesktestapp.azurewebsites.net/api/services/app/Campaign/GetCampaigns?FilterPublished=true&FilterWillBePublished=true&FilterExpired=true&FilterPassive=true&SortingLastCreated=true&SortingDeadline=true&SortingPopularity=true&StartDate=04.04.2018&EndDate=04.04.2019&Page=1&SkipCount=0&MaxResultCount=100";
  private readonly apiUrl_Delete = "http://proximitydesktestapp.azurewebsites.net/api/services/app/Campaign/DeleteCampaign?id="
  private readonly apiUrl_Create = "http://proximitydesktestapp.azurewebsites.net/api/services/app/Campaign/CreateCampaign"
